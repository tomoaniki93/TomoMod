...
local categories = {
    ...
    { key = "damagemeter", label = LT("cat_damagemeter", "Damage Meter"),  icon = ICON_PATH .. "icon_diagnostics.tga", accent = { 0.80, 0.27, 1.00 }, desc = LT("cat_damagemeter_desc", "Compteur de degats, recap de mort et recap de donjon."), kw = "damage meter dps hps degats soins recap mort donjon compteur tdm" },
