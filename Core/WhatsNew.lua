...
CHANGELOG = {
    {
        ...
        highlights = {
            ...
            L["wn_352_settings"] or "Note — The part to know before you update: the Action Bars options page is a single message for this release, and the bars come up on the new module's own defaults rather than on the values you had set. What you had is not lost — it is still sitting in your profile, untouched — but every control on that page wrote to a system that no longer exists, and leaving forty-five of them on screen quietly doing nothing would have been worse than saying so plainly. The page returns in the next update, wired to what the bars actually read now, and your settings return with it.",
        },
    },
    {
        version = "3.5.1",
