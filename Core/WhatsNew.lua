...
CHANGELOG = {
    {
        ...
        highlights = {
            ...
            L["wn_400_comfort_workspace"] or "New — Comfort is now a grouped workspace in the options sidebar. Automation, Players, Classes, CVars, World Quest and Other keep the quality-of-life pages organised at a glance, including a dedicated Consumables page for the readiness tracker. The settings, previews, nested tabs, search and direct links you already use are unchanged.",
