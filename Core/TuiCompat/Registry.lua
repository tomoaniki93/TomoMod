-- =====================================================================
-- Core/TuiCompat/Registry.lua
-- Ported from Tui (TUI/core/registry.lua): namespace line and the chat
-- prefix in the error path are the only edits.
-- =====================================================================
...
local function SafeCallRefresh(name, fn)
    ...
    if not ok then
        print("|cFFFF6666TomoMod:|r refresh error [" .. name .. "]: " .. tostring(err))
    end
end
