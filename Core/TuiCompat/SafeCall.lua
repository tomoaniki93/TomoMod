-- =====================================================================
-- Core/TuiCompat/SafeCall.lua
-- Ported verbatim from Tui (TUI/core/safecall.lua) except for the namespace
-- line. Only the header differs, so upstream changes stay diffable.
-- =====================================================================
