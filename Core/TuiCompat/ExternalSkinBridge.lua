-- =====================================================================
-- Core/TuiCompat/ExternalSkinBridge.lua
-- Ported from Tui (TUI/core/external_skin_bridge.lua). Optional Masque
-- support: without Masque installed every entry point is a no-op.
-- The Masque group is registered as "TomoMod" rather than "TUI".
-- =====================================================================
...
local function GetGroup(surfaceKey)
    ...
    if not g then
        g = lib:Group("TomoMod", surfaceKey)
