    ...
    if event == "PARTY_INVITE_REQUEST" then
        ...
        if isTrusted then
            ...
            if settings.showMessages then
                print("|cff2e9dd8TomoMod:|r " .. TomoMod_L["msg_aai_accepted"]
                    .. inviterName .. " (" .. source .. ")")
            end
            ...
            if settings.showMessages then
                print("|cff2e9dd8TomoMod:|r " .. TomoMod_L["msg_aai_ignored"]
...
function AAI.SetEnabled(enabled)
    ...
    if enabled then
        ...
        print("|cff2e9dd8TomoMod:|r " .. TomoMod_L["msg_aai_enabled"])
    else
        if mainFrame then
            mainFrame:UnregisterAllEvents()
            mainFrame:SetScript("OnEvent", nil)
        end
        print("|cff2e9dd8TomoMod:|r " .. TomoMod_L["msg_aai_disabled"])
    end
end
