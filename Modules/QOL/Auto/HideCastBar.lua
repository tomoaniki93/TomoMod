...
function HCB.Initialize()
    if not TomoModDB then
        print("|cffff0000TomoMod HideCastBar:|r TomoModDB non initialisée")
        return
    end
    ...
    print("|cff00ff00TomoMod HideCastBar:|r Module initialisé")
end
...
function HCB.SetEnabled(enabled)
    ...
    if enabled then
        print("|cff00ff00TomoMod:|r Barre de cast cachée")
    else
        print("|cff00ff00TomoMod:|r Barre de cast affichée")
    end
end
