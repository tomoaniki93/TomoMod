...
L["SETTINGS_RECAPS"] = "回顾"
L["SETTINGS_SHOW_SELF"] = "始终显示我的条目"
L["SETTINGS_BAR_TOOLTIPS"] = "条目提示"
L["SETTINGS_TIMER_POS"] = "计时器位置"
L["SETTINGS_TIMER_LEFT"] = "左侧"
L["SETTINGS_TIMER_RIGHT"] = "右侧"
L["SETTINGS_AUTO_RESET"] = "进入副本时重置"
L["SETTINGS_DEATH_RECAP_AUTO"] = "自动显示死亡回顾"
L["DM_STANDALONE"] = "已安装独立的 TomoDamageMeter 插件并由其接管；其设置在它自己的窗口中。内置模块保持停用。"
L["DM_UNAVAILABLE"] = "此客户端不提供暴雪伤害统计，模块未启用。"
L["DM_WINDOWS_HINT"] = "列、添加窗口和分类筛选在统计窗口中设置。"
L["DM_OPEN_WINDOW_SETTINGS"] = "窗口设置"
L["DM_TOGGLE_WINDOWS"] = "显示 / 隐藏"
