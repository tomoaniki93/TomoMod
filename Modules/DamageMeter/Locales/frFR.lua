...
L["SETTINGS_RECAPS"] = "Récapitulatifs"
L["SETTINGS_SHOW_SELF"] = "Toujours afficher ma barre"
L["SETTINGS_BAR_TOOLTIPS"] = "Infobulles sur les barres"
L["SETTINGS_TIMER_POS"] = "Position du chronomètre"
L["SETTINGS_TIMER_LEFT"] = "Gauche"
L["SETTINGS_TIMER_RIGHT"] = "Droite"
L["SETTINGS_AUTO_RESET"] = "Réinitialiser en entrant en instance"
L["SETTINGS_DEATH_RECAP_AUTO"] = "Récap de mort automatique"
L["DM_STANDALONE"] = "L'addon TomoDamageMeter autonome est installé : c'est lui qui gère le compteur, et ses réglages sont dans sa propre fenêtre. Le module intégré reste en veille pour éviter deux fenêtres concurrentes."
L["DM_UNAVAILABLE"] = "Le compteur de dégâts de Blizzard n'est pas disponible sur ce client, le module est inactif."
L["DM_WINDOWS_HINT"] = "Les colonnes, l'ajout de fenêtres et le filtrage par catégorie se règlent dans la fenêtre du compteur, au plus près de la fenêtre concernée."
L["DM_OPEN_WINDOW_SETTINGS"] = "Réglages des fenêtres"
L["DM_TOGGLE_WINDOWS"] = "Afficher / masquer"
...
-- Benchmark / Historique des combats
L["BENCHMARK_TITLE"] = "Test de dégâts"
L["BENCHMARK_TIP"] = "Ouvrir le test de dégâts"
L["BENCHMARK_READY"] = "Prêt pour un nouveau test."
L["BENCHMARK_ARMED"] = "En attente du combat..."
L["BENCHMARK_WAIT_DATA"] = "En attente de données de dégâts lisibles..."
L["BENCHMARK_RUNNING"] = "Test en cours..."
L["BENCHMARK_COMPLETE"] = "Test terminé."
L["BENCHMARK_CANCELLED"] = "Test annulé."
L["BENCHMARK_NO_DAMAGE"] = "Aucun dégât enregistré."
L["BENCHMARK_DURATION"] = "Durée"
L["BENCHMARK_AUTO_DUMMY_ON"] = "Mannequin auto : Oui"
L["BENCHMARK_AUTO_DUMMY_OFF"] = "Mannequin auto : Non"
L["BENCHMARK_START"] = "Démarrer"
L["BENCHMARK_STOP"] = "Arrêter"
L["BENCHMARK_DPS"] = "DPS moyen"
L["BENCHMARK_DAMAGE"] = "Dégâts"
L["BENCHMARK_TOP5"] = "Top 5 local"
L["BENCHMARK_CLEAR"] = "Effacer l'historique"
L["BENCHMARK_EMPTY"] = "Aucun test enregistré."
L["BENCHMARK_COL_PLAYER"] = "Personnage"
L["BENCHMARK_COL_SPEC"] = "Spé"
L["BENCHMARK_COL_ILVL"] = "Niv. objet"
L["BENCHMARK_COL_TIME"] = "Durée"
L["BENCHMARK_COL_DATE"] = "Date"
L["CMD_HELP_BENCHMARK"] = "  /tdm benchmark [30|60|120] — ouvrir le test de dégâts"
L["FIGHT_HISTORY"] = "Historique des combats"
L["FIGHT_HISTORY_TIP"] = "Ouvrir l'historique persistant des combats"
L["FIGHT_HISTORY_ALL"] = "Tous les combats"
L["FIGHT_HISTORY_BOSSES"] = "Boss uniquement"
L["FIGHT_HISTORY_CLEAR"] = "Effacer l'historique"
L["FIGHT_HISTORY_EMPTY"] = "Aucun combat de donjon, raid ou scénario enregistré."
L["FIGHT_HISTORY_DAMAGE"] = "Dégâts"
L["FIGHT_HISTORY_HEALING"] = "Soins"
L["FIGHT_HISTORY_BOSS"] = "Boss"
L["FIGHT_HISTORY_TRASH"] = "Trash"
L["FIGHT_HISTORY_PLAYER"] = "Joueur"
L["FIGHT_HISTORY_INTERRUPTS"] = "Int."
L["FIGHT_HISTORY_DEATHS"] = "Morts"
L["FIGHT_HISTORY_PREV"] = "Précédent"
L["FIGHT_HISTORY_NEXT"] = "Suivant"
L["FIGHT_HISTORY_KILL"] = "Victoire"
L["FIGHT_HISTORY_WIPE"] = "Échec"
L["HISTORY_GUI"] = "Historique"
L["HISTORY_GUI_DESC"] = "Historique persistant des combats de donjon, raid et scénario."
L["DM_HISTORY_BENCHMARK"] = "Historique et benchmark"
L["DM_HISTORY_BENCHMARK_DESC"] = "Consulter l'historique persistant des combats ou lancer un test DPS chronométré."
