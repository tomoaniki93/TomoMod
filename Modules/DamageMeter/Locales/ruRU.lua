...
L["SETTINGS_OPACITY"] = "Непрозрачность"
L["SETTINGS_RECAPS"] = "Сводки"
L["SETTINGS_SHOW_SELF"] = "Всегда показывать мою полосу"
L["SETTINGS_BAR_TOOLTIPS"] = "Подсказки на полосах"
L["SETTINGS_TIMER_POS"] = "Положение таймера"
L["SETTINGS_TIMER_LEFT"] = "Слева"
L["SETTINGS_TIMER_RIGHT"] = "Справа"
L["SETTINGS_AUTO_RESET"] = "Сбрасывать при входе в подземелье"
L["SETTINGS_DEATH_RECAP_AUTO"] = "Автоматически показывать сводку смерти"
L["DM_STANDALONE"] = "Установлен отдельный аддон TomoDamageMeter, он и управляет счётчиком; его настройки в собственном окне. Встроенный модуль отключён."
L["DM_UNAVAILABLE"] = "Счётчик урона Blizzard недоступен на этом клиенте, модуль не активен."
L["DM_WINDOWS_HINT"] = "Столбцы, добавление окон и фильтр по категориям настраиваются в окне счётчика."
L["DM_OPEN_WINDOW_SETTINGS"] = "Настройки окон"
L["DM_TOGGLE_WINDOWS"] = "Показать / скрыть"
