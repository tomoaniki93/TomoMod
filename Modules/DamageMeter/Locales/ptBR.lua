...
L["SETTINGS_OPACITY"] = "Opacidade"
L["SETTINGS_RECAPS"] = "Resumos"
L["SETTINGS_SHOW_SELF"] = "Sempre mostrar minha barra"
L["SETTINGS_BAR_TOOLTIPS"] = "Dicas nas barras"
L["SETTINGS_TIMER_POS"] = "Posição do cronômetro"
L["SETTINGS_TIMER_LEFT"] = "Esquerda"
L["SETTINGS_TIMER_RIGHT"] = "Direita"
L["SETTINGS_AUTO_RESET"] = "Reiniciar ao entrar em uma instância"
L["SETTINGS_DEATH_RECAP_AUTO"] = "Mostrar o resumo de morte automaticamente"
L["DM_STANDALONE"] = "O addon TomoDamageMeter independente está instalado e gerencia o medidor; seus ajustes estão na janela dele. O módulo integrado permanece inativo."
L["DM_UNAVAILABLE"] = "O medidor de dano da Blizzard não está disponível neste cliente, o módulo está inativo."
L["DM_WINDOWS_HINT"] = "Colunas, adicionar janelas e filtro por categoria são ajustados na janela do medidor."
L["DM_OPEN_WINDOW_SETTINGS"] = "Ajustes das janelas"
...
-- Benchmark / Histórico de Combates
L["BENCHMARK_TITLE"] = "Benchmark de dano"
L["BENCHMARK_TIP"] = "Abrir o benchmark de dano"
L["BENCHMARK_READY"] = "Pronto para um novo teste."
L["BENCHMARK_ARMED"] = "Aguardando o combate..."
L["BENCHMARK_WAIT_DATA"] = "Aguardando dados de dano legíveis..."
L["BENCHMARK_RUNNING"] = "Teste em andamento..."
L["BENCHMARK_COMPLETE"] = "Teste concluído."
L["BENCHMARK_CANCELLED"] = "Teste cancelado."
L["BENCHMARK_NO_DAMAGE"] = "Nenhum dano foi registrado."
L["BENCHMARK_DURATION"] = "Duração"
L["BENCHMARK_AUTO_DUMMY_ON"] = "Boneco automático: Sim"
L["BENCHMARK_AUTO_DUMMY_OFF"] = "Boneco automático: Não"
L["BENCHMARK_START"] = "Iniciar"
L["BENCHMARK_STOP"] = "Parar"
L["BENCHMARK_DPS"] = "DPS médio"
L["BENCHMARK_DAMAGE"] = "Dano"
L["BENCHMARK_TOP5"] = "Top 5 local"
L["BENCHMARK_CLEAR"] = "Limpar histórico"
L["BENCHMARK_EMPTY"] = "Nenhum benchmark registrado ainda."
L["BENCHMARK_COL_PLAYER"] = "Personagem"
L["BENCHMARK_COL_SPEC"] = "Especialização"
L["BENCHMARK_COL_ILVL"] = "Nível do item"
L["BENCHMARK_COL_TIME"] = "Tempo"
L["BENCHMARK_COL_DATE"] = "Data"
L["CMD_HELP_BENCHMARK"] = "  /tdm benchmark [30|60|120] — abrir o benchmark de dano"
L["FIGHT_HISTORY"] = "Histórico de Combates"
L["FIGHT_HISTORY_TIP"] = "Abrir o histórico persistente de combates"
L["FIGHT_HISTORY_ALL"] = "Todos os combates"
L["FIGHT_HISTORY_BOSSES"] = "Somente chefes"
L["FIGHT_HISTORY_CLEAR"] = "Limpar histórico"
L["FIGHT_HISTORY_EMPTY"] = "Nenhuma luta de masmorra, raide ou cenário foi salva."
L["FIGHT_HISTORY_DAMAGE"] = "Dano"
L["FIGHT_HISTORY_HEALING"] = "Cura"
L["FIGHT_HISTORY_BOSS"] = "Chefe"
L["FIGHT_HISTORY_TRASH"] = "Trash"
L["FIGHT_HISTORY_PLAYER"] = "Jogador"
L["FIGHT_HISTORY_INTERRUPTS"] = "Interr."
L["FIGHT_HISTORY_DEATHS"] = "Mortes"
L["FIGHT_HISTORY_PREV"] = "Anterior"
L["FIGHT_HISTORY_NEXT"] = "Próximo"
L["FIGHT_HISTORY_KILL"] = "Vitória"
L["FIGHT_HISTORY_WIPE"] = "Derrota"
L["HISTORY_GUI"] = "Histórico"
L["HISTORY_GUI_DESC"] = "Histórico persistente de lutas de masmorra, raide e cenário."
L["DM_HISTORY_BENCHMARK"] = "Histórico e benchmark"
L["DM_HISTORY_BENCHMARK_DESC"] = "Consulte o histórico persistente ou inicie um teste de DPS cronometrado."
