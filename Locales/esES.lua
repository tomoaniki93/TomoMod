...
TomoMod_RegisterLocale("esES", {
    ...
    ["wn_335_cdf_aura_probe"] = "CooldownForge: /tm forge log ahora informa de lo que el juego dejó leer realmente a TomoMod sobre tus beneficios — cuántas actualizaciones de aura llegaron, cuántas de ellas traían un número de hechizo legible, esas mismas dos cifras solo en combate, y qué hechizos seguía dispuesto a nombrar el juego durante una pelea. También muestra cuál de las cuatro maneras que tiene TomoMod de encontrar un beneficio es la que responde, y cuántas veces se recurrió siquiera a cada una — porque un método que nunca funciona y un método al que nunca le llega el turno se ven exactamente igual desde fuera. Cuando un beneficio rastreado se niega a aparecer, son esas líneas las que te dicen si es algo que podemos arreglar o un límite que impone el juego, algo que nada más permitía distinguir. En pantalla no cambia nada, y los contadores vuelven a cero en cada recarga — así que una medición limpia de un solo combate pide un /reload antes del pull.",
