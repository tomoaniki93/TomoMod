...
TomoMod_RegisterLocale("esES", {
    ...
    ["wn_335_cdm_viewers"] = "Cooldowns: las cuatro barras del Cooldown Manager de Blizzard ya se pueden ocultar una por una, desde el panel de Cooldowns junto al botón del Cooldown Studio — Essential, Utility y las dos pantallas de seguimiento de beneficios tienen cada una su casilla. Marcar una quita esa barra de la pantalla y del modo de colocación de TomoMod, y deja las otras tres donde están. Sustituye a una casilla única que no ocultaba nada: se limitaba a detener el reestilizado de TomoMod sobre esas barras, que seguían en pantalla con el aspecto propio de Blizzard — una casilla llamada «ocultar las barras del Cooldown Manager» que las hacía más visibles en lugar de menos. Una barra oculta se vuelve invisible y no clicable, no se elimina: sigue siendo la barra de Blizzard, sigue funcionando por debajo, y si existe o no se decide todavía en el modo edición de Blizzard. Desmarcarla la devuelve exactamente donde la habías colocado. El interruptor de CD y Recursos no ha cambiado y responde a otra pregunta — si TomoMod reestiliza estas barras, no cuáles quieres ver.",
