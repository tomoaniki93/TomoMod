...
TomoMod_RegisterLocale("esES", {
    ...
    ["wn_344_dm_config"] = "Nuevo — Una página de Medidor de daño en las opciones de TomoMod. Por ahora es una puerta de entrada y no los ajustes en sí: indica dónde está la ventana de ajustes propia del medidor, la abre, y muestra u oculta las ventanas del medidor. Es a propósito — un conjunto de opciones copiado a medias y en desacuerdo con las de verdad sería peor que una página que asume ser un atajo, y la integración real es el siguiente paso. En los dos casos en que no hay nada que abrir — el addon independiente ha tomado el relevo, o tu cliente no ofrece datos del medidor — la página dice cuál de los dos, en vez de ofrecer un botón sin efecto.",
