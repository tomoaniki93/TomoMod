...
TomoMod_RegisterLocale("esES", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns: el panel de Cooldowns lleva ahora una casilla «Ocultar las barras del Cooldown Manager» junto al botón del Cooldown Studio. Cuando tus tiempos de reutilización ya están en tus propias barras, el reestilizado que TomoMod hace de los cuatro visores de Blizzard no tiene nada que hacer — y su interruptor estaba en otra categoría, que no es donde estás cuando llegas a esa conclusión. Es el mismo ajuste que el de CD y Recursos, formulado al revés. Ojo: detiene el reestilizado de TomoMod sobre esos visores; apagar los visores en sí se hace en el modo edición de Blizzard.",
