...
TomoMod_RegisterLocale("esES", {
    ...
    ["pf_info_cooldowns"]                = "Rastrea los enfriamientos de interrupción y rez de combate de cada miembro del grupo.",
    ...
    ["ins_v3_welcome_desc"]      = "¡Bienvenido! Este asistente rápido te deja una interfaz limpia y completa en segundos.\n\nElige una configuración acorde a tu forma de jugar — podrás ajustarlo todo después desde |cff0cd29f/tm|r. ¿Prefieres elegir cada opción tú mismo? Elige |cffc89530Personalizado|r.",
    ...
    ["ins_recap_preset"]         = "Configuración aplicada: |cff0cd29f%s|r",
    ["ins_recap_custom"]         = "Tu configuración personalizada está lista",
    ["ins_recap_desc"]           = "Recarga tu interfaz para aplicarlo todo. Puedes reabrir este asistente cuando quieras con |cff0cd29f/tm install|r, y abrir el panel de configuración completo con |cff0cd29f/tm|r.",
    ["cat_accueil"]              = "Inicio",
