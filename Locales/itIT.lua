...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns: il pannello Cooldowns porta ora una casella «Nascondere le barre del Cooldown Manager», accanto al pulsante del Cooldown Studio. Una volta che i tuoi tempi di recupero sono sulle tue barre, la rivisitazione grafica che TomoMod fa dei quattro visualizzatori di Blizzard non ha più nulla da fare — e il suo interruttore stava in un'altra categoria, che non è dove ti trovi quando arrivi a quella conclusione. È la stessa impostazione di quella in CD e Risorse, formulata al contrario. Attenzione: interrompe la rivisitazione di TomoMod su quei visualizzatori; spegnere i visualizzatori stessi si fa nella modalità modifica di Blizzard.",
