...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_345_aura_engine"] = "Nuovo — Gli effetti negativi e positivi sulle targhette nemiche mancavano per gran parte di uno scontro, e nulla lo segnalava: nessun errore, niente sulla targhetta, solo un vuoto dove avrebbe dovuto esserci ciò che volevi vedere. Tutto il resto di questa versione rende innocua una lettura di aura rifiutata; niente di ciò fa tornare l'aura, perché il gioco non la consegna mentre si combatte. Quindi TomoMod smette di chiedere. Ora descrive ciò che vuole — queste aure, in questa quantità, disposte così, con questo aspetto — e il gioco cerca e ordina da sé, restituendo le icone già pronte. Dalla parte di TomoMod nulla legge più un'aura, quindi non resta nulla da rifiutare. Il vecchio metodo è stato rimosso anziché tenuto di scorta: questa versione richiede già la patch che porta il nuovo, e una scorta che nessuno percorre mai è una scorta che marcisce in silenzio. Strada facendo sono emersi due bug. Nascondere una targhetta cercava ancora l'elenco di icone che non esiste più, il che avrebbe generato un errore a ogni nemico morto e a ogni targhetta fuori portata. E un'icona creata nel mezzo di uno scontro usciva senza dimensioni e non disegnava nulla, in modo permanente: il gioco rifiuta di dimensionarla in combattimento come rifiuta di consegnare l'aura, e l'icona veniva preparata una volta sola. Ora le icone ricordano la dimensione che attendono e la prendono appena il gioco lo consente.",
