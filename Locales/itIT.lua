...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_335_cdf_aura"] = "CooldownForge: un'icona può seguire un buff invece di un tempo di recupero. Imposta una voce su «buff monitorato» e resterà fuori dallo schermo finché il buff è assente, per poi comparire con la durata residua e i cumuli finché è attivo — così un proc può stare sulla stessa barra accanto all'abilità che lo concede. Puoi anche indicare un ID di buff diverso, per i proc concessi da un incantesimo e applicati come un altro. In Mitica+ il gioco può non permettere ai componenti aggiuntivi di leggere la durata di un buff; lì l'icona compare e scompare comunque correttamente, semplicemente senza timer.",
