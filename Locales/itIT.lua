...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_335_cdf_aura_probe"] = "CooldownForge: /tm forge log ora riporta ciò che il gioco ha davvero lasciato leggere a TomoMod sui tuoi benefici — quanti aggiornamenti d'aura sono arrivati, quanti di questi portavano un numero d'incantesimo leggibile, le stesse due cifre limitate al combattimento, e quali incantesimi il gioco era ancora disposto a nominare durante uno scontro. Mostra anche quale delle quattro strade che TomoMod ha per trovare un beneficio è quella che risponde, e quante volte ciascuna è stata anche solo interpellata — perché una strada che non funziona mai e una strada a cui non tocca mai il turno, viste da fuori, sono identiche. Quando un beneficio monitorato si rifiuta di comparire, sono quelle righe a dirti se si tratta di qualcosa che possiamo sistemare o di un limite imposto dal gioco, cosa che nient'altro permetteva di distinguere. Sullo schermo non cambia nulla, e i contatori ripartono da zero a ogni ricaricamento — una misurazione pulita di un singolo combattimento richiede quindi un /reload prima del pull.",
