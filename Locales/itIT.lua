...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_345_aura_engine"] = "Nuovo — Gli effetti negativi sulle targhette nemiche mancavano per gran parte di uno scontro, e nulla lo segnalava: nessun errore, niente sulla targhetta, solo un vuoto dove avrebbe dovuto esserci ciò che volevi vedere. Tutto il resto di questa versione rende innocua una lettura di aura rifiutata; niente di ciò fa tornare l'aura, perché il gioco semplicemente non la consegna mentre si combatte. Quindi si smette di chiedere. TomoMod ora descrive ciò che vuole — questi effetti, in questa quantità, disposti così, con questo aspetto — e il gioco cerca e ordina da sé, restituendo le icone già pronte. Dalla parte di TomoMod nulla legge più un'aura, quindi non resta nulla da rifiutare. È volutamente un primo tentativo, e solo per gli effetti negativi sulle targhette: il vecchio metodo resta e continua a funzionare sui client che non hanno questa possibilità, nessuno perde le proprie aure per il cambio. Se regge nei dungeon veri, tutto il resto che legge aure seguirà la stessa strada. Una cosa da tenere d'occhio, meglio dirla che scoprirla dopo: un'icona creata nel mezzo di uno scontro può uscire senza dimensioni e non disegnare nulla, ed è la parte che ha bisogno di combattimenti reali per essere confermata.",
