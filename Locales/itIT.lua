...
TomoMod_RegisterLocale("itIT", {
    ...
    ["wn_344_dm_config"] = "Nuovo — Una pagina Misuratore di danni nelle opzioni di TomoMod. Per ora è una porta d'ingresso e non le impostazioni vere e proprie: indica dove si trova la finestra delle impostazioni del misuratore, la apre e mostra o nasconde le finestre del misuratore. È voluto — un insieme di opzioni ricopiato a metà e in disaccordo con quelle vere sarebbe peggio di una pagina che ammette di essere una scorciatoia, e l'integrazione vera è il passo successivo. Nei due casi in cui non c'è nulla da aprire — l'addon autonomo ha preso il controllo, oppure il tuo client non fornisce dati del misuratore — la pagina dice quale dei due, invece di offrire un pulsante che non fa nulla.",
