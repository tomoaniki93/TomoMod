...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns: o painel Cooldowns agora traz uma caixa «Ocultar as barras do Cooldown Manager», ao lado do botão do Cooldown Studio. Quando os seus tempos de recarga já estão nas suas próprias barras, o revestimento que o TomoMod aplica aos quatro visualizadores da Blizzard não tem mais o que fazer — e o interruptor dele ficava em outra categoria, que não é onde você está quando chega a essa conclusão. É o mesmo ajuste do painel CD e Recursos, escrito ao contrário. Atenção: ele interrompe o revestimento do TomoMod nesses visualizadores; desligar os visualizadores em si é feito no modo de edição da Blizzard.",
