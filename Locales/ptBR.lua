...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_345_aura_engine"] = "Novo — As penalidades e bênçãos nas placas de nome inimigas sumiam durante boa parte de um combate, e nada avisava: nenhum erro, nada na placa, só um vazio onde deveria estar o que você queria ver. Todo o resto desta versão torna inofensiva uma leitura de aura recusada; nada disso faz a aura voltar, porque o jogo não a entrega enquanto há luta. Então o TomoMod para de perguntar. Agora ele descreve o que quer — estas auras, esta quantidade, dispostas assim, com esta aparência — e o jogo procura e ordena sozinho, devolvendo os ícones prontos. Do lado do TomoMod nada mais lê uma aura, então não sobra nada a recusar. O jeito antigo foi removido em vez de guardado como reserva: esta versão já exige o patch que traz o novo, e uma reserva que ninguém nunca percorre é uma reserva que apodrece em silêncio. Dois bugs apareceram no caminho. Esconder uma placa ainda buscava a lista de ícones que não existe mais, o que teria gerado um erro toda vez que um inimigo morria ou uma placa saía de alcance. E um ícone criado no meio de um combate saía sem tamanho e não desenhava nada, de forma permanente: o jogo recusa dimensioná-lo em combate assim como recusa entregar a aura, e o ícone só era preparado uma vez. Agora os ícones lembram o tamanho que esperam e o assumem assim que o jogo permite.",
