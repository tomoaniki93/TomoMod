...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_400_foundation"] = "Nota — Por baixo de tudo isso, o TomoMod mantém agora uma descrição única do próprio conteúdo: 68 entradas cobrindo cada ajuste que ele guarda, em nove grupos, com 29 elementos móveis declarados. Nada muda na tela por causa disso. O que isso traz são as próximas versões: os perfis por tipo de conteúdo, a importação parcial de um perfil e o novo motor de posicionamento vão todos ler dessa mesma lista, em vez de cada um reconstruir a sua, ligeiramente diferente.",
