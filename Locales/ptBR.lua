...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_335_cdf_aura_probe"] = "CooldownForge: /tm forge log agora relata o que o jogo realmente deixou o TomoMod ler sobre os seus bônus — quantas atualizações de aura chegaram, quantas delas traziam um número de magia legível, esses mesmos dois números apenas em combate, e quais magias o jogo ainda se dispunha a nomear durante uma luta. Ele também mostra qual dos quatro caminhos que o TomoMod tem para encontrar um bônus é o que responde, e quantas vezes cada um chegou sequer a ser consultado — porque um caminho que nunca funciona e um caminho que nunca tem a sua vez são idênticos vistos de fora. Quando um bônus monitorado se recusa a aparecer, são essas linhas que dizem se é algo que podemos corrigir ou um limite imposto pelo jogo, o que nada mais permitia distinguir. Nada muda na tela, e os contadores voltam a zero a cada recarregamento — uma medição limpa de um único combate pede um /reload antes do pull.",
