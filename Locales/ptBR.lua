...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_400_comfort_workspace"] = "Novidade — Conforto agora é um espaço de trabalho agrupado na barra lateral das opções. Automação, Jogadores, Classes, CVars, Missões Mundiais e Outros organizam de forma clara as páginas de qualidade de vida, incluindo uma página de Consumíveis dedicada ao controle de preparação. As configurações, prévias, abas aninhadas, busca e links diretos que você já usa não mudam.",
