...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_352_settings"] = "Observação — O que convém saber antes de atualizar: a página de opções das barras de ação é uma única mensagem nesta versão, e as barras sobem com os valores padrão do novo módulo em vez dos que você havia definido. O que você tinha não se perdeu — continua no seu perfil, intacto —, mas cada controle daquela página escrevia num sistema que não existe mais, e deixar quarenta e cinco deles na tela sem efeito algum teria sido pior do que dizer isso com franqueza. A página volta na próxima atualização, ligada ao que as barras realmente leem agora, e seus ajustes voltam com ela.",
