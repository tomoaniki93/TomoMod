...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_344_dm_config"] = "Novo — Uma página de Medidor de dano nas opções do TomoMod. Por enquanto ela é uma porta de entrada e não os ajustes em si: informa onde fica a janela de ajustes do próprio medidor, abre essa janela, e mostra ou oculta as janelas do medidor. É proposital — um conjunto de opções copiado pela metade e em desacordo com as verdadeiras seria pior do que uma página que assume ser um atalho, e a integração de verdade é o próximo passo. Nos dois casos em que não há nada a abrir — o addon independente assumiu, ou seu cliente não fornece dados do medidor — a página diz qual deles, em vez de oferecer um botão sem efeito.",
