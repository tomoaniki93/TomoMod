...
TomoMod_RegisterLocale("ptBR", {
    ...
    ["wn_345_aura_engine"] = "Novo — As penalidades nas placas de nome inimigas sumiam durante boa parte de um combate, e nada avisava: nenhum erro, nada na placa, só um vazio onde deveria estar o que você queria ver. Todo o resto desta versão torna inofensiva uma leitura de aura recusada; nada disso faz a aura voltar, porque o jogo simplesmente não a entrega enquanto há luta. Então para-se de perguntar. O TomoMod agora descreve o que quer — estas penalidades, esta quantidade, dispostas assim, com esta aparência — e o jogo procura e ordena sozinho, devolvendo os ícones prontos. Do lado do TomoMod nada mais lê uma aura, então não sobra nada a recusar. É de propósito uma primeira tentativa, e apenas para as penalidades das placas: o jeito antigo continua ali e segue funcionando em clientes que não têm isso, ninguém perde suas auras na troca. Se aguentar em masmorras de verdade, todo o resto que lê auras seguirá o mesmo caminho. Uma coisa a observar, e melhor dizer do que descobrir depois: um ícone montado no meio de um combate pode sair sem tamanho e não desenhar nada, e essa é a parte que precisa de lutas reais para se confirmar.",
