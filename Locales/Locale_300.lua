...
TomoMod_RegisterLocale("enUS", {
    ...
    ["compass_fov_narrow"] = "Narrow (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Standard (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Wide (\xC2\xB190\xC2\xB0)",
    ...
    ["opt_compass_show_heading"] = "Show heading readout (e.g. 245\xC2\xB0 SW)",
    ["compass_dir_n"] = "N",
    ["compass_dir_e"] = "E",
    ["compass_dir_s"] = "S",
    ["compass_dir_w"] = "W",
...
TomoMod_RegisterLocale("frFR", {
    ...
    ["info_compass_desc"] = "Une barre de cap en haut de l'\xC3\xA9cran qui fait d\xC3\xA9filer les points cardinaux quand vous tournez, avec un marqueur pointant vers la qu\xC3\xAAte suivie ou un point de route - la m\xC3\xAAme cible que le beam. En lecture seule, donc aucun risque de taint.",
    ["info_compass_layout"] = "Astuce : ouvrez le mode Placement (/tm layout) pour glisser la barre o\xC3\xB9 vous voulez.",
    ...
    ["opt_compass_scale"] = "\xC3\x89chelle",
    ["opt_compass_fov"] = "Champ visible",
    ["compass_fov_narrow"] = "\xC3\x89troit (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Standard (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Large (\xC2\xB190\xC2\xB0)",
    ["opt_compass_show_quest"] = "Afficher le marqueur de qu\xC3\xAAte suivie",
    ...
    ["opt_compass_show_heading"] = "Afficher le cap (ex. 245\xC2\xB0 SO)",
    ["compass_dir_n"] = "N",
    ["compass_dir_e"] = "E",
    ["compass_dir_s"] = "S",
    ["compass_dir_w"] = "O",
    ["msg_help_compass"] = "Afficher/masquer la barre de boussole",
    ["wn_305_compass"] = "Nouvelle barre de Boussole (Waypoint 2.0) : une barre de cap optionnelle en haut de l'\xC3\xA9cran qui fait d\xC3\xA9filer les points cardinaux quand vous tournez, avec des marqueurs ambre/teal pointant vers la qu\xC3\xAAte suivie et le point de route. Enti\xC3\xA8rement d\xC3\xA9pla\xC3\xA7able en mode Placement et configurable dans Confort de jeu > Boussole.",
    -- [3.0.2] Changelog (What is New)
...
TomoMod_RegisterLocale("deDE", {
    ...
    ["info_compass_desc"] = "Eine Richtungsleiste am oberen Bildschirmrand, die beim Drehen die Himmelsrichtungen durchl\xC3\xA4uft, mit einer Markierung in Richtung deiner verfolgten Quest oder eines Karten-Wegpunkts - dasselbe Ziel wie der Strahl. Nur lesend, daher kein Taint-Risiko.",
    ["info_compass_layout"] = "Tipp: \xC3\x96ffne den Layout-Modus (/tm layout), um die Leiste frei zu verschieben.",
    ["opt_compass_enable"] = "Kompassleiste aktivieren",
    ["opt_compass_width"] = "Leistenbreite",
    ["opt_compass_height"] = "Leistenh\xC3\xB6he",
    ["opt_compass_scale"] = "Skalierung",
    ["opt_compass_fov"] = "Sichtfeld",
    ["compass_fov_narrow"] = "Eng (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Standard (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Weit (\xC2\xB190\xC2\xB0)",
...
TomoMod_RegisterLocale("esES", {
    -- [3.0.5] Compass (Waypoint 2.0)
    ["tab_qol_compass"] = "Br\xC3\xBAjula",
    ["mover_compass"] = "Br\xC3\xBAjula",
    ["section_compass"] = "Barra de br\xC3\xBAjula",
    ["info_compass_desc"] = "Una barra de rumbo en la parte superior de la pantalla que recorre los puntos cardinales al girar, con un marcador que apunta hacia tu misi\xC3\xB3n seguida o un punto de mapa: el mismo objetivo que el haz. Solo lectura, as\xC3\xAD que no puede causar taint.",
    ["info_compass_layout"] = "Consejo: abre el modo Dise\xC3\xB1o (/tm layout) para arrastrar la barra donde quieras.",
    ["opt_compass_enable"] = "Activar la barra de br\xC3\xBAjula",
    ["opt_compass_width"] = "Ancho de la barra",
    ["opt_compass_height"] = "Alto de la barra",
    ["opt_compass_scale"] = "Escala",
    ["opt_compass_fov"] = "Campo de visi\xC3\xB3n",
    ["compass_fov_narrow"] = "Estrecho (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Est\xC3\xA1ndar (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Amplio (\xC2\xB190\xC2\xB0)",
    ["opt_compass_show_quest"] = "Mostrar marcador de misi\xC3\xB3n seguida",
    ["opt_compass_show_waypoint"] = "Mostrar marcador de punto de mapa",
    ["opt_compass_show_distance"] = "Mostrar distancia en los marcadores",
    ["opt_compass_show_heading"] = "Mostrar el rumbo (p. ej. 245\xC2\xB0 SO)",
    ["compass_dir_n"] = "N",
    ["compass_dir_e"] = "E",
    ["compass_dir_s"] = "S",
    ["compass_dir_w"] = "O",
    ["msg_help_compass"] = "Alternar la barra de br\xC3\xBAjula",
    ["wn_305_compass"] = "Nueva barra de Br\xC3\xBAjula (Waypoint 2.0): una barra de rumbo opcional en la parte superior de la pantalla que recorre los puntos cardinales al girar, con marcadores \xC3\xA1mbar/turquesa que apuntan hacia tu misi\xC3\xB3n seguida y un punto de mapa. Totalmente movible en modo Dise\xC3\xB1o y configurable en Calidad de vida > Br\xC3\xBAjula.",
    -- [3.0.2] Changelog (What is New)
...
TomoMod_RegisterLocale("itIT", {
    ...
    ["info_compass_desc"] = "Una barra di direzione in alto sullo schermo che scorre i punti cardinali mentre ti giri, con un indicatore che punta verso la missione tracciata o un punto sulla mappa: lo stesso bersaglio del raggio. Sola lettura, quindi non pu\xC3\xB2 causare taint.",
    ["info_compass_layout"] = "Suggerimento: apri la modalit\xC3\xA0 Layout (/tm layout) per trascinare la barra dove vuoi.",
    ...
    ["compass_fov_narrow"] = "Stretto (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Standard (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Ampio (\xC2\xB190\xC2\xB0)",
    ...
    ["opt_compass_show_heading"] = "Mostra la direzione (es. 245\xC2\xB0 SO)",
    ["compass_dir_n"] = "N",
    ["compass_dir_e"] = "E",
    ["compass_dir_s"] = "S",
    ["compass_dir_w"] = "O",
    ["msg_help_compass"] = "Attiva/disattiva la barra bussola",
    ["wn_305_compass"] = "Nuova barra Bussola (Waypoint 2.0): una barra di direzione opzionale in alto sullo schermo che scorre i punti cardinali mentre ti giri, con indicatori ambra/turchese che puntano verso la missione tracciata e un punto sulla mappa. Completamente spostabile in modalit\xC3\xA0 Layout e configurabile in Comfort di gioco > Bussola.",
    -- [3.0.2] Changelog (What is New)
...
TomoMod_RegisterLocale("ptBR", {
    -- [3.0.5] Compass (Waypoint 2.0)
    ["tab_qol_compass"] = "B\xC3\xBAssola",
    ["mover_compass"] = "B\xC3\xBAssola",
    ["section_compass"] = "Barra de b\xC3\xBAssola",
    ["info_compass_desc"] = "Uma barra de dire\xC3\xA7\xC3\xA3o no topo da tela que percorre os pontos cardeais ao girar, com um marcador apontando para sua miss\xC3\xA3o rastreada ou um ponto no mapa - o mesmo alvo do feixe. Somente leitura, ent\xC3\xA3o n\xC3\xA3o causa taint.",
    ["info_compass_layout"] = "Dica: abra o modo Layout (/tm layout) para arrastar a barra para onde quiser.",
    ["opt_compass_enable"] = "Ativar a barra de b\xC3\xBAssola",
    ["opt_compass_width"] = "Largura da barra",
    ["opt_compass_height"] = "Altura da barra",
    ["opt_compass_scale"] = "Escala",
    ["opt_compass_fov"] = "Campo de vis\xC3\xA3o",
    ["compass_fov_narrow"] = "Estreito (\xC2\xB145\xC2\xB0)",
    ["compass_fov_standard"] = "Padr\xC3\xA3o (\xC2\xB160\xC2\xB0)",
    ["compass_fov_wide"] = "Amplo (\xC2\xB190\xC2\xB0)",
    ["opt_compass_show_quest"] = "Mostrar marcador da miss\xC3\xA3o rastreada",
    ["opt_compass_show_waypoint"] = "Mostrar marcador do ponto no mapa",
    ["opt_compass_show_distance"] = "Mostrar dist\xC3\xA2ncia nos marcadores",
    ["opt_compass_show_heading"] = "Mostrar a dire\xC3\xA7\xC3\xA3o (ex.: 245\xC2\xB0 SO)",
    ["compass_dir_n"] = "N",
    ["compass_dir_e"] = "L",
    ["compass_dir_s"] = "S",
    ["compass_dir_w"] = "O",
    ["msg_help_compass"] = "Alternar a barra de b\xC3\xBAssola",
    ["wn_305_compass"] = "Nova barra de B\xC3\xBAssola (Waypoint 2.0): uma barra de dire\xC3\xA7\xC3\xA3o opcional no topo da tela que percorre os pontos cardeais ao girar, com marcadores \xC3\xA2mbar/turquesa apontando para sua miss\xC3\xA3o rastreada e um ponto no mapa. Totalmente m\xC3\xB3vel no modo Layout e configur\xC3\xA1vel em Qualidade de vida > B\xC3\xBAssola.",
    -- [3.0.2] Changelog (What is New)
