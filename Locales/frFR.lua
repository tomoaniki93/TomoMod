...
TomoMod_RegisterLocale("frFR", {
    ...
    ["bagskin_de_badge"]                 = "DE",
    ["bagskin_de_tooltip"]               = "|cff2ed884[Clic-droit]|r D\195\169senchanter",
    ...
    -- Aura Tracker
    -- ═══════════════════════════════════
    ["tab_qol_aura_tracker"]             = "Suivi d'auras",
    ["mover_auratracker"]                = "Suivi d'auras",
    ...
    ["info_rb_primary_centered"]      = "Déplace la barre de mana/énergie/rage du player frame vers le centre de l'écran.",
    ["opt_rb_primary_power_height"]   = "Haut. barre principale",
    ...
    ["info_cb_anchor_uf"]             = "Cette castbar s'ancre sur le cadre d'unité correspondant (elle apparaît donc sur la frame de la cible / du focus / du familier / du boss).",
    ["tab_qol_compass"]               = "Boussole",
    ["section_compass"]               = "Barre boussole",
    ["info_compass_desc"]             = "Une barre de cap en haut de l'écran affichant N/E/S/O quand tu tournes, avec un marqueur pointant vers ta quête suivie ou ton point de carte. Lecture seule - aucun taint.",
    ["info_compass_layout"]           = "Astuce : utilise le mode Layout (/tm layout) pour glisser la barre où tu veux.",
    ["opt_compass_enable"]            = "Activer la barre boussole",
