...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns : le panneau Cooldowns porte désormais une case « Masquer les barres du Cooldown Manager », à côté du bouton du Cooldown Studio. Une fois vos cooldowns sur vos propres barres, l'habillage TomoMod des quatre viewers de Blizzard n'a plus rien à faire — et son interrupteur se trouvait dans une autre catégorie, qui n'est pas là où vous êtes au moment où vous arrivez à cette conclusion. C'est le même réglage que celui de CD & Ressources, formulé dans l'autre sens. À noter : il arrête l'habillage TomoMod de ces viewers ; couper les viewers eux-mêmes se fait dans le mode édition de Blizzard.",
