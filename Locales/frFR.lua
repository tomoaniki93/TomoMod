...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_345_aura_engine"] = "Nouveau — Les affaiblissements et les améliorations sur les plaques ennemies manquaient pendant la plus grande partie d'un pull, et rien ne le signalait : aucune erreur, rien sur la plaque, juste un vide là où aurait dû se trouver ce qu'on voulait voir. Tout le reste de cette version rend une lecture d'aura refusée inoffensive ; rien n'y fait revenir l'aura, parce que le jeu refuse de la donner tant qu'un combat est en cours. Alors TomoMod cesse de demander. Il décrit désormais ce qu'il veut — ces auras, en telle quantité, disposées ainsi, habillées ainsi — et le jeu se charge lui-même de chercher et de trier, puis rend les icônes terminées. Plus rien côté TomoMod ne lit une aura, il n'y a donc plus rien à refuser. L'ancienne méthode a été supprimée plutôt que gardée en secours : cette version exige déjà le patch qui fournit la nouvelle, et un secours que personne n'emprunte jamais est un secours qui pourrit en silence. Deux bugs ont été attrapés au passage. Masquer une plaque allait encore chercher la liste d'icônes qui n'existe plus, ce qui aurait levé une erreur à chaque mort de mob et à chaque plaque sortant de portée. Et une icône créée au milieu d'un combat sortait sans taille et n'affichait rien du tout, définitivement : le jeu refuse de la dimensionner en plein combat comme il refuse de donner l'aura, et l'icône n'était mise en place qu'une seule fois. Les icônes retiennent maintenant la taille qu'elles attendent et la prennent dès que le jeu l'autorise.",
