...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_345_aura_engine"] = "Nouveau — Les auras manquaient pendant la plus grande partie d'un pull, et rien ne le signalait : aucune erreur, rien sur la plaque ni sur le cadre, juste un vide là où aurait dû se trouver ce qu'on voulait voir. Tout le reste de cette version rend une lecture d'aura refusée inoffensive ; rien n'y fait revenir l'aura, parce que le jeu refuse de la donner tant qu'un combat est en cours. Alors TomoMod cesse de demander. Il décrit désormais ce qu'il veut — ces auras, en telle quantité, disposées ainsi, habillées ainsi — et le jeu se charge lui-même de chercher et de trier, puis rend les icônes terminées. Plus rien côté TomoMod ne lit une aura, il n'y a donc plus rien à refuser. Toutes les rangées d'auras de l'addon fonctionnent ainsi maintenant : affaiblissements et améliorations des plaques, auras et buffs de cible sur vos cadres, icônes de soins persistants du groupe, affaiblissements et soins persistants du raid. Les rangées de soins persistants ont demandé une étape de plus : elles reposaient sur la reconnaissance de sorts précis, et le sort est justement ce qui est masqué — la liste des sorts à surveiller est donc remise au jeu d'avance, et c'est lui qui trie. Une chose reste volontairement à l'ancienne : le liseré coloré qui signale un joueur à dissiper. Le jeu accepte de colorer ses propres icônes d'aura, mais il ne peut pas dire quel type d'effet touche quelqu'un sans nous laisser regarder ; cet indicateur dépend donc toujours de la lisibilité des auras, et c'est dit plutôt que passé sous silence. Trois bugs ont été attrapés au passage : une erreur à chaque disparition de plaque, des icônes créées en plein combat qui sortaient sans taille et restaient invisibles définitivement, et les interrupteurs d'affichage des affaiblissements et des soins persistants qui ne prenaient plus effet avant un rechargement.",
