...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_335_cdf_aura_probe"] = "CooldownForge : /tm forge log indique désormais ce que le jeu a réellement laissé lire à TomoMod au sujet de vos buffs — combien de mises à jour d'aura sont arrivées, combien d'entre elles portaient un numéro de sort lisible, les deux mêmes chiffres en combat uniquement, et quels sorts le jeu acceptait encore de nommer pendant un combat. Il indique aussi laquelle des quatre méthodes dont TomoMod dispose pour retrouver un buff est celle qui répond, et combien de fois chacune a seulement été sollicitée — car une méthode qui ne fonctionne jamais et une méthode à qui l'on ne donne jamais son tour se ressemblent parfaitement vues de l'extérieur. Quand un buff suivi refuse d'apparaître, ce sont ces lignes qui vous disent s'il s'agit de quelque chose que nous pouvons corriger ou d'une limite imposée par le jeu, ce que rien d'autre ne permettait de distinguer. Rien ne change à l'écran, et les compteurs repartent de zéro à chaque rechargement — une mesure propre sur un seul combat demande donc un /reload avant le pull.",
