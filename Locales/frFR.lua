...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_345_aura_engine"] = "Nouveau — Les affaiblissements sur les plaques ennemies manquaient pendant la plus grande partie d'un pull, et rien ne le signalait : aucune erreur, rien sur la plaque, juste un vide là où aurait dû se trouver ce qu'on voulait voir. Tout le reste de cette version rend une lecture d'aura refusée inoffensive ; rien n'y fait revenir l'aura, parce que le jeu refuse simplement de la donner tant qu'un combat est en cours. Alors on cesse de demander. TomoMod décrit désormais ce qu'il veut — ces affaiblissements, en telle quantité, disposés ainsi, habillés ainsi — et le jeu se charge lui-même de chercher et de trier, puis rend les icônes terminées. Plus rien côté TomoMod ne lit une aura, il n'y a donc plus rien à refuser. C'est volontairement un premier essai, et seulement pour les affaiblissements des plaques : l'ancienne méthode reste en place et continue de fonctionner sur les clients qui n'ont pas cette nouveauté, personne ne perd ses auras au passage. Si l'essai tient en donjon réel, tout ce qui lit des auras suivra le même chemin. Un point à surveiller, et autant le dire franchement plutôt que de le découvrir plus tard : une icône mise en place au milieu d'un pull peut sortir sans taille et ne rien afficher, et c'est la partie qui demande de vrais combats pour être confirmée.",
