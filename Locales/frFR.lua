...
TomoMod_RegisterLocale("frFR", {
    ...
    ["wn_344_dm_config"] = "Nouveau — Une page Damage Meter dans les options de TomoMod. Pour l'instant c'est une porte d'entrée plutôt que les réglages eux-mêmes : elle indique où se trouve la fenêtre de réglages du compteur, l'ouvre, et affiche ou masque les fenêtres du compteur. C'est volontaire — un jeu d'options à moitié recopié et en désaccord avec les vrais réglages serait pire qu'une page qui assume d'être un raccourci, et la véritable intégration est l'étape suivante. Dans les deux cas où il n'y a rien à ouvrir — l'addon autonome a pris le relais, ou ton client ne fournit pas de données de compteur — la page dit lequel, au lieu de proposer un bouton sans effet.",
