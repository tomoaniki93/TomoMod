...
TomoMod_RegisterLocale("deDE", {
    ...
    ["time_tooltip_left_click"]         = "|cff2e9dd8Linksklick:|r Kalender",
    ["time_tooltip_right_click"]        = "|cff2e9dd8Rechtsklick:|r Server / Lokal",
    ["time_tooltip_shift_right"]        = "|cff2e9dd8Shift + Rechtsklick:|r 12h / 24h",
    ...
    ["opt_sound_volume"]                = "Lautstärke des Audiokanals",
    ["info_sound_volume"]               = "Ändert die globale Lautstärke des ausgewählten Kanals in den Audioeinstellungen von WoW.",
    ...
    ["opt_chat_skin_bg_alpha"]           = "Deckkraft des Rahmens",
    ["opt_chat_message_bg_alpha"]        = "Deckkraft des Nachrichtenbereichs",
    ...
    ["tmt_unlock_msg"]              = "|cff2e9dd8TomoMod|r M+ Tracker: Rahmen entsperrt \226\128\148 ziehen zum Verschieben.",
    ["tmt_lock_msg"]                = "|cff2e9dd8TomoMod|r M+ Tracker: Rahmen gesperrt.",
    ["tmt_reset_msg"]               = "|cff2e9dd8TomoMod|r M+ Tracker: Position zurückgesetzt.",
    ["tmt_unknown_cmd"]             = "|cff2e9dd8TomoMod|r M+ Tracker: Unbekannter Befehl.",
    ["tmt_key_level"]               = "+%d",
    ...
    ["tmt_splits_cleared"]            = "|cff2e9dd8TomoMod|r M+ Tracker: Aufgezeichnete Zeiten gel\195\182scht.",
    ...
    ["tmt_preview_active"]          = "|cff2e9dd8TomoMod|r M+ Tracker: Vorschau aktiv \226\128\148 |cFF55B400/tmt lock|r zum Sperren.",
    ...
    ["mhub_tp_not_learned"]          = "|cff2e9dd8TomoMod|r: Teleportzauber nicht gelernt.",
    ...
    -- Navigation
    ["ins_header_title"]             = "|cff2e9dd8Tomo|r|cffe4e4e4Mod|r  \226\128\148  Einrichtungsassistent",
    ...
    ["ins_welcome_desc"]             = "Dieser Assistent f\195\188hrt Sie in |cff2e9dd816 Schritten|r durch die Konfiguration von TomoMod:\nUnitFrames, Party Frames, Zauberleisten, Nameplates, Aktionsleisten,\nRessourcen, Skins, Sound, Mythic+, QOL, Optimierungen und SkyRide.\n\nAlle Optionen k\195\182nnen jederzeit \195\188ber |cff2e9dd8/tm|r ge\195\164ndert werden.",
    ...
    ["ins_done_recap"]               = "Deine TomoMod-Konfiguration ist gespeichert. Hier einige Hinweise:\n\n|cff2e9dd8/tm|r              |TInterface\\BUTTONS\\UI-SpellbookIcon-NextPage:0|t  Konfigurationspanel \195\182ffnen\n|cff2e9dd8/tm sr|r           |TInterface\\BUTTONS\\UI-SpellbookIcon-NextPage:0|t  Elemente entsperren und verschieben\n|cff2e9dd8/tm install|r      |TInterface\\BUTTONS\\UI-SpellbookIcon-NextPage:0|t  Diesen Installer neu starten\n\nAlle hier konfigurierten Optionen k\195\182nnen jederzeit\n\195\188ber die entsprechenden Panels in der TomoMod-GUI ge\195\164ndert werden.\n\nEin |cff2e9dd8UI-Reload|r ist erforderlich, um bestimmte \195\132nderungen anzuwenden\n(Nameplates, Skins, UnitFrames).",
    ...
    ["bags_v4_quality_style"]            = "Gegenstandsqualität",
    ["bags_v4_quality_tint"]             = "Getöntes Feld",
    ["bags_v4_quality_border"]           = "Farbiger Rahmen",
    ["bags_v4_quality_both"]             = "Beides",
    ["bags_v4_quality_none"]             = "Keine",
    ...
    ["ts_reset_msg"]                = "|cff2e9dd8TomoMod|r Anzeigetafel: Position zurückgesetzt.",
    ["ts_no_data"]                  = "|cff2e9dd8TomoMod|r Anzeigetafel: Keine Dungeon-Daten verfügbar.",
    ...
    ["wn_footer"]                        = "Alle Einstellungen k\195\182nnen jederzeit \195\188ber |cff2e9dd8/tm|r ge\195\164ndert werden.",
    ...
    ["ins_v3_welcome_desc"]      = "Willkommen! Dieser schnelle Assistent richtet dir in Sekunden eine saubere, vollständige Oberfläche ein.\n\nWähle eine Konfiguration, die zu deiner Spielweise passt — du kannst danach alles über |cff2e9dd8/tm|r feineinstellen. Möchtest du jede Option selbst wählen? Nimm |cffc89530Benutzerdefiniert|r.",
    ...
    ["ins_recap_preset"]         = "Konfiguration angewendet: |cff2e9dd8%s|r",
    ...
    -- 3.1.2
    ["wn_312_brand"]         = "Akzentfarbe von #0cd29f auf #2e9dd8 (Mintgrün) in der gesamten Benutzeroberfläche aktualisiert — Titelleiste, Panels, Chat-Nachrichten, Popups und Standard-Farbwerte.",
    ...
    ["wn_400_context_tools"] = "Neu — Ein Profilwechsel schließt die geöffneten Werkzeuge nicht mehr. Das Diagnosefenster, die Addon-Erkennung und die Studios bleiben bei einem Inhaltswechsel genau so, wie ihr sie verlassen habt: ein im Schlachtzug geöffnetes Studio schließt sich nicht, wenn ihr danach einen Schlüsselstein startet. Ein von Hand geladenes Profil ersetzt weiterhin alles, denn genau das verlangt ihr mit dem Klick.",
    ["wn_400_context_combat"] = "Neu — Ein Inhaltswechsel mitten im Pull wartet. Das Einsetzen eines Schlüsselsteins versetzt euch sofort in den Kampf, also wird der Wechsel bis zum Kampfende zurückgehalten und erst dann angewendet, statt eure Rahmen mitten im Pull neu zu erzeugen. Und beide Profile werden verglichen, bevor irgendetwas angewendet wird: Ihr werdet nur dann zum Neuladen aufgefordert, wenn der Wechsel wirklich ändert, welche Module eingeschaltet sind — eine andere Größe, Farbe oder Position wird sofort und wortlos übernommen.",
    ["wn_400_ready_tracker"] = "Neu — Eine Bereitschaftsanzeige für Gruppeninhalte. TomoMod überwacht nun Ihr Fläschchen, Ihren Nahrungsbuff und das Öl auf Ihrer Waffe gemeinsam und sagt Ihnen auf einen Blick, ob alle drei anliegen. Sie sitzt neben der Uhr unter der Minikarte und lässt sich überall öffnen, leuchtet aber nur dort auf, wo es darauf ankommt: Das Symbol bleibt weiß, solange Sie allein unterwegs sind, und wird grün oder rot, sobald Sie einen Dungeon, einen Schlachtzug, ein Szenario oder eine Tiefe betreten.",
    ["wn_400_ready_tracker_button"] = "Neu — Die Anzeige sitzt als kleine Schaltfläche neben der Uhr unter der Minikarte: türkis, wenn alles anliegt, rot, sobald etwas fehlt. Fahren Sie mit der Maus darüber, um die drei Zeilen einzeln zu lesen, klicken Sie links, um eine Leiste mit Symbol und Restdauer jedes Effekts zu öffnen, und rechts, um die Schaltfläche auf die andere Seite der Uhr zu setzen. Eine Waffe in jeder Hand verlangt zwei Öle und zeigt Ihnen, wie viele aufgetragen sind; ein Schild oder ein in der Nebenhand gehaltener Gegenstand zählt nicht mit, denn beide lassen sich nicht ölen. Dieselben zwei Einstellungen finden Sie in den Optionen, unter Allgemein, im Abschnitt Informationsleiste.",
    ["wn_400_live_toggles"] = "Neu — Die meisten Module von TomoMod lassen sich jetzt ein- und ausschalten, ohne die Benutzeroberfläche neu zu laden. 27 der 62 Module greifen in dem Moment, in dem Sie den Schalter umlegen, statt nur ein Kennzeichen zu setzen und Sie erst neu laden zu lassen, bevor überhaupt etwas geschieht. Die übrigen brauchen weiterhin ein Neuladen, und sie verlangen es nur noch dann, wenn es einen echten Grund dafür gibt.",
    ["wn_400_combat_defer"] = "Neu — Ein mitten im Kampf umgelegter Schalter wird weder abgewiesen noch halb ausgeführt. Eine Änderung, die einen geschützten Rahmen neu aufbauen müsste, wartet bis zum Ende des Kampfes und wird dann automatisch angewendet, und TomoMod sagt Ihnen, dass es wartet. Die im Kampf unbedenklichen Änderungen — schnelles Plündern, automatische Reparatur, die Hinweise und die Überwachungen — greifen sofort: Sie für das Abschalten des automatischen Plünderns aus einem Kampf zu holen, wäre reine Schaumschlägerei.",
    ["wn_400_dependencies"] = "Neu — Module wissen, wovon sie abhängen. Eines auszuschalten schaltet nun auch jene aus, die ohne es nicht arbeiten können, und nennt sie beim Namen; eines einzuschalten warnt Sie, wenn etwas, das es braucht, noch aus ist. Nichts bleibt mehr stillschweigend halb verbunden.",
    ["wn_400_reload_honest"] = "Geändert — Die Aufforderung zum Neuladen ist nicht mehr TomoMods Antwort auf jeden einzelnen Schalter. Sie erscheint bei den 14 Modulen, die ihre Arbeit im laufenden Spiel tatsächlich nicht rückgängig machen können — geschützte Schaltflächen, die im Kampf nicht neu erzeugt werden dürfen, und Hooks, die sich nach dem Einhängen nicht mehr entfernen lassen — und sonst nirgends.",
    ["wn_400_reload_batch"] = "Neu — Wenn eine Änderung wirklich ein Neuladen braucht, fragt TomoMod einmal statt einmal pro Klick. Fünf Kästchen nacheinander anzuhaken wirft am Ende eine einzige Frage auf, und „Später“ zu wählen bewahrt Ihre Antwort, statt sie zu verwerfen: ein kleines Banner am oberen Bildschirmrand führt dann auf, was aussteht, und lädt neu, sobald Sie so weit sind. Eine Änderung vor dem Neuladen zurückzunehmen, streicht sie von selbst aus dieser Liste — eine Einstellung wieder so zu setzen, wie sie beim Anmelden war, muss nicht mehr durch ein Neuladen bestätigt werden.",
    ["wn_400_inventory"] = "Neu — /tm modules gibt alles aus, was TomoMod enthält, gruppiert wie die Optionen, mit dem Zustand jedes Moduls und der Angabe, ob es sich im laufenden Betrieb ändern lässt oder ein Neuladen braucht. /tm modules <Schlüssel> schaltet eines direkt aus dem Chatfenster um. Für sich genommen nützlich — und der schnellste Weg, um herauszufinden, welche Ihrer Module im laufenden Betrieb umschaltbar sind und welche nicht.",
    ["wn_400_foundation"] = "Hinweis — Unter alldem führt TomoMod nun eine einzige Beschreibung seines eigenen Inhalts: 68 Einträge für jede Einstellung, die es speichert, in neun Gruppen, mit 29 deklarierten verschiebbaren Elementen. Auf dem Bildschirm ändert sich dadurch nichts. Was es einbringt, zeigt sich bereits: Die Inhaltsprofile oben lesen aus dieser einen Liste, und der teilweise Import eines Profils sowie die neue Positionierungs-Engine werden das ebenfalls tun, statt sich jeweils eine eigene, leicht abweichende zu bauen.",
    ["wn_400_interface_workspace"] = "Neu — Interface ist jetzt ein eigener Arbeitsbereich in der Optionsseitenleiste. Die Seiten Allgemein, Aktionsleisten, Skins und Sound stehen direkt darunter, während Startseite, Rollen, Profile und Diagnose mit einem Klick erreichbar bleiben. Die Seiten selbst, ihre Untertabs, Suche und Direktlinks funktionieren weiterhin genau wie zuvor.",
    ["wn_400_units_workspace"] = "Neu — Einheiten nutzt jetzt dieselbe Arbeitsbereichsnavigation. UnitFrames, Nameplates, Gruppen- und Schlachtzugsfenster stehen direkt unter Einheiten in der Seitenleiste, damit zusammengehörige Seiten zusammenbleiben. Ihre vorhandenen Einstellungen, Vorschauen und Untertabs bleiben unverändert.",
    ...
    -- 3.6.5 — What's New
    -- =====================
    ["wn_365_mplus_stats_compare"] = "Fehlerbehebung — Die Seite Statistiken des Mythic+ Studios löst keinen Fehler mehr aus, sobald zwei oder mehr Läufe aufgezeichnet sind. Die Vergleichskarte formatiert die Zeit jedes Laufs, und die dafür genutzte Funktion war an der Stelle, an der diese Karte aufgebaut wird, noch nicht sichtbar: Die Seite brach mitten im Zeichnen ab und der Vergleich erschien nie. Ein frisches Profil wirkte unauffällig, weil die Karte erst ab dem zweiten aufgezeichneten Schlüssel gebaut wird.",
    ["wn_365_mplus_compare_columns"] = "Fehlerbehebung — Die Vergleichstabelle auf der Seite Statistiken des Mythic+ Studios wird wieder innerhalb ihrer Karte gezeichnet. Ihre drei Wertespalten — Lauf A, Lauf B und die Differenz — lagen rechts außerhalb des Panels, sodass die Zeilenbeschriftungen ohne jede Zahl daneben erschienen. Die Spalten und die beiden Laufnamen darüber werden jetzt von der oberen linken Ecke der Karte aus platziert und bleiben darin.",
    ["wn_365_mplus_compare_polish"] = "Neu — Die Vergleichstabelle liest sich endlich wie eine Tabelle: ein Kopfband, eine Linie vor jeder Spalte, jede zweite Zeile hinterlegt und die Zahlen mittig unter ihrer Überschrift. Die Differenzspalte ist jetzt farbig — grün, wenn der zweite Lauf der bessere ist, rot, wenn er schlechter ist, grau, wenn es nichts zu vergleichen gibt — und zwar mit der richtigen Richtung je Zeile: eine höhere Schlüsselstufe ist eine Verbesserung, eine niedrigere Zeit, Todeszahl, Gegnerkräfte-Zeit oder Boss-Zwischenzeit ebenfalls.",
    ["wn_365_teleport_launcher"] = "Geändert — Die Mythic+-Teleportschaltfläche auf deinem Charakterbogen ist jetzt ein kleines, dezentes Symbol direkt links neben dem Schließen-Knopf des Bogens, statt des großen Symbols in der oberen rechten Ecke. Sie öffnet genau dasselbe Teleportfenster und verhält sich unverändert — sie macht der Kopfzeile des Charakterbogens nur keine Konkurrenz mehr.",
    ["wn_365_chat_secret_channel"] = "Fehlerbehebung — Kanalhinweise stören das Chatfenster nicht mehr. Das Spiel übergibt dem Chat inzwischen bei manchen Kanalhinweisen einen geschützten Wert statt eines Namens, und ein solcher Wert darf nicht mit Text verglichen werden — die Zuordnung eines Hinweises zu seinem Kanal konnte also fehlschlagen, bevor der Hinweis überhaupt ausgegeben wurde. TomoMods Chat-Skin prüft jetzt vor dem Vergleich, ob der Wert geschützt ist; Beitritts-, Verlassens-, Einladungs- und Falsches-Passwort-Hinweise werden wieder normal behandelt.",
    ...
    ["wn_364_mythichub_keys"] = "Fehlerbehebung — Das alte Mythic+-Fenster greift deine Tastatur nicht mehr ab. Es ließ sich mit Escape schließen, und ein Fenster, das auf Tasten lauscht, kann die schlucken, die das Spiel braucht — deine Bewegungstasten, Springen, deine Tastenbelegungen —, solange es offen ist. Es wird jetzt nur noch mit der Maus bedient, wie TomoScore und das Mythic+-Studio: Schließe es über sein X.",
    ["wn_364_teleport_menu"] = "Neu — Dein Charakterfenster erhält eine Schaltfläche, die alle Mythisch+-Dungeonteleporte der aktuellen Saison an einem Ort öffnet. Klicke auf einen Dungeon, um dorthin zu teleportieren. Noch nicht freigeschaltete Teleporte werden weiterhin angezeigt, nur ausgegraut, sodass du auf einen Blick siehst, was dir noch fehlt. Das Fenster folgt der Saison von selbst und ist im Kampf nicht verfügbar.",
    ...
    ["wn_363_aura_spacing"] = "Behoben — Der von dir eingestellte Abstand zwischen Aurensymbolen wird wieder angewendet. Er wurde unter den alten Optionsnamen an das Spiel übergeben, die die aktuelle Aurenanzeige ignoriert, sodass jede Reihe unabhängig von deiner Einstellung mit dem Standardabstand des Spiels gezeichnet wurde.",
    ["wn_363_aura_size"] = "Behoben — Eine Änderung der Größe oder der Anzahl der Aurensymbole wirkt wieder sofort. Sie wurde bisher durch einen Neuaufbau der Symbolgruppe angewendet, was das Spiel nicht mehr erlaubt: Die Symbole behielten deshalb ihre bisherige Größe, bis die Rahmen neu aufgebaut wurden — in der Praxis bis zu einem Neuladen. Bereits sichtbare Symbole werden jetzt an Ort und Stelle angepasst, nicht nur die, die danach erscheinen.",
    ["wn_363_aura_recycle"] = "Behoben — Eine Gruppen- oder Schlachtzugszelle bzw. eine Namensplakette, die einer neuen Einheit zugewiesen wird, zeigt nicht länger die Auren der vorherigen Einheit. Beim Freigeben eines Rahmens wird seine Aurenanzeige jetzt abgeschaltet, was ihre Symbole löscht, statt nur die Einheit zu lösen und die Anzeige weiter lauschen zu lassen.",
    ["wn_363_healer_studio"] = "Behoben — Healer Studio profitiert von allem oben Genannten: Seine Indikatoren erscheinen, sobald ein Zauber ausgewählt ist, der Größenregler verschiebt auch bereits sichtbare Symbole, und das Abwählen eines Zaubers löscht sein Symbol sofort, statt es auf einer wiederverwendeten Zelle zurückzulassen.",
    ["wn_363_probe"] = "Behoben — Die Buff-Überwachung von Cooldown Studio wird vollständig beendet, wenn ein Symbol keinen Buff mehr verfolgt, statt einen ungenutzten Beobachter für den Rest der Sitzung weiterlaufen zu lassen.",
    ["wn_363_revive_color"] = "Behoben — Ein wiederbelebter Spieler behält auf seinem Gruppen- oder Schlachtzugsrahmen nicht länger die graue Todesfärbung. Der Rahmen wurde neu eingefärbt, während das Spiel den Spieler noch als tot meldete, und danach färbte ihn nichts mehr neu: Die falsche Farbe blieb also bis zu einem Neuladen. Er wird jetzt in dem Moment neu eingefärbt, in dem sich der Zustand des Spielers tatsächlich ändert — das deckt auch einen Verbindungsabbruch mit anschließender Rückkehr ab.",
    ["wn_363_tomoscore_keys"] = "Behoben — Die Wertungsübersicht am Ende eines Dungeons blockiert deine Bewegungstasten nicht mehr. Sie öffnet sich von selbst, wenn ein Schlüssel beendet ist, und war so eingestellt, dass sie auf die Tastatur reagiert, damit Escape sie schließen kann — was verhindern konnte, dass deine Bewegungstasten das Spiel erreichen. Sie ist wieder rein mausgesteuert: Schließe sie über ihre Schaltfläche, alle Tastenbelegungen funktionieren weiter, während sie angezeigt wird.",
    ["wn_363_raid_event_gate"] = "Geändert — Schlachtzugsrahmen lauschen nicht mehr auf Lebens-, Ressourcen- und Aurenaktualisierungen, solange du nicht in einem Schlachtzug bist. Das Modul wurde von jeder Einheit im Spiel geweckt — Gruppenmitglieder, Namensplaketten, Bosse, dein Ziel —, um nach einem Schlachtzugsrahmen zu suchen, den es gar nicht geben konnte. Es abonniert jetzt, wenn du einem Schlachtzug beitrittst, und hört auf, wenn du ihn verlässt — auch mitten im Kampf.",
    ["wn_363_leveling_bar"] = "Behoben — Die Aufstiegsleiste lässt sich wieder einschalten. Ihr Rahmen wurde unter demselben globalen Namen veröffentlicht wie das Modul, das ihn steuert: Die Leiste einmal zu erzeugen ersetzte also das Modul, und von da an taten die Option, die Regler für Breite und Höhe, der Verschieber und /tm sr kommentarlos nichts mehr — das Häkchen ließ die Einstellung eingeschaltet zurück, ohne dass eine Leiste zu sehen war.",
    ["wn_363_dk_runes"] = "Geändert — Todesritterrunen werden mit einer einfarbigen Füllung gezeichnet statt mit der gemeinsamen Balkentextur mit Farbverlauf. Der Verlauf wirkt auf einer hohen Lebensleiste wie ein Glanzlicht, auf sechs kurzen Runensegmenten machte er die Farbe nur unsauber.",
    ["wn_363_forge_drag"] = "Geändert — Beim Ablegen eines Elements in AstralForge wird es jetzt an der nächstgelegenen Ecke, Kante oder Mitte dessen verankert, worauf es liegt — genau wie es Healer Studio bereits tat. Der Ankerpunkt änderte sich bisher nie: Ein in eine Ecke geschobenes Teil hing weiterhin über einen langen Versatz an der Fenstermitte und verrutschte, sobald das Fenster in der Größe geändert wurde. Elemente, die du bewusst an einem anderen Element statt am Fenster verankert hast, behalten diese Verbindung.",
    -- =====================
    -- 3.6.2 — What's New
    -- =====================
