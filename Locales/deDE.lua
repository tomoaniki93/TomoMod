...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_344_dm_config"] = "Neu — Eine Seite Schadensmesser in TomoMods Optionen. Vorerst ist sie eine Tür und nicht die Einstellungen selbst: Sie nennt dir, wo das eigene Einstellungsfenster des Messers liegt, öffnet es und blendet die Messfenster ein oder aus. Das ist Absicht — ein halb übertragener Satz Optionen, der den echten widerspricht, wäre schlimmer als eine Seite, die offen eine Abkürzung ist, und die richtige Einbindung ist der nächste Schritt. In den beiden Fällen, in denen es nichts zu öffnen gibt — das eigenständige Addon hat übernommen, oder dein Client liefert keine Messdaten — sagt die Seite, welcher davon zutrifft, statt eine Schaltfläche ohne Wirkung anzubieten.",
