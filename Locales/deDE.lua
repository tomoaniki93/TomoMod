...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_400_foundation"] = "Hinweis — Unter alldem führt TomoMod nun eine einzige Beschreibung seines eigenen Inhalts: 68 Einträge für jede Einstellung, die es speichert, in neun Gruppen, mit 29 deklarierten verschiebbaren Elementen. Auf dem Bildschirm ändert sich dadurch nichts. Was es einbringt, sind die nächsten Versionen: Profile je nach Inhaltstyp, der teilweise Import eines Profils und die neue Positionierungs-Engine werden alle aus dieser einen Liste lesen, statt sich jeweils eine eigene, leicht abweichende zu bauen.",
