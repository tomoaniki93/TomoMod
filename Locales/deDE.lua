...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_335_cdf_aura_probe"] = "CooldownForge: /tm forge log meldet nun, was das Spiel TomoMod über Ihre Buffs tatsächlich lesen ließ — wie viele Aura-Meldungen ankamen, wie viele davon eine lesbare Zaubernummer trugen, dieselben beiden Zahlen nur für den Kampf, und welche Zauber das Spiel während eines Kampfes noch zu benennen bereit war. Zusätzlich zeigt er, welcher der vier Wege, auf denen TomoMod einen Buff findet, tatsächlich antwortet, und wie oft jeder überhaupt gefragt wurde — denn ein Weg, der nie funktioniert, und ein Weg, der nie an die Reihe kommt, sehen von außen genau gleich aus. Wenn ein verfolgter Buff nicht erscheinen will, sagen Ihnen genau diese Zeilen, ob es etwas ist, das wir beheben können, oder eine Grenze, die das Spiel setzt — was sonst nicht zu unterscheiden war. Auf dem Bildschirm ändert sich nichts, und die Zähler beginnen bei jedem Neuladen von vorn — eine saubere Messung eines einzelnen Kampfes verlangt also ein /reload vor dem Pull.",
