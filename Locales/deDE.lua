...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_345_aura_engine"] = "Neu — Schwächungszauber auf feindlichen Namensplaketten fehlten während des größten Teils eines Kampfes, und nichts wies darauf hin: kein Fehler, nichts auf der Plakette, nur eine Lücke dort, wo das Gesuchte hätte stehen sollen. Alles andere in dieser Version macht eine verweigerte Aura-Abfrage harmlos; nichts davon bringt die Aura zurück, denn das Spiel rückt sie schlicht nicht heraus, solange gekämpft wird. Also wird nicht mehr gefragt. TomoMod beschreibt jetzt, was es will — diese Schwächungszauber, so viele, so angeordnet, so gestaltet — und das Spiel sucht und sortiert selbst und reicht die fertigen Symbole zurück. Auf TomoMods Seite liest nichts mehr eine Aura, also bleibt nichts mehr zu verweigern. Das ist bewusst ein erster Versuch und gilt nur für die Schwächungszauber auf Plaketten: Der alte Weg bleibt bestehen und läuft weiter auf Clients ohne diese Möglichkeit, niemand verliert dabei seine Auren. Hält der Versuch in echten Dungeons, folgt alles Weitere, das Auren liest, demselben Weg. Ein Punkt zum Beobachten, offen gesagt statt später entdeckt: Ein Symbol, das mitten im Kampf eingerichtet wird, kann ohne Größe herauskommen und nichts zeichnen — genau das muss sich in echten Kämpfen zeigen.",
