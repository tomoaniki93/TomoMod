...
TomoMod_RegisterLocale("deDE", {
    ...
    ["ins_v3_welcome_desc"]      = "Willkommen! Dieser schnelle Assistent richtet dir in Sekunden eine saubere, vollständige Oberfläche ein.\n\nWähle eine Konfiguration, die zu deiner Spielweise passt — du kannst danach alles über |cff0cd29f/tm|r feineinstellen. Möchtest du jede Option selbst wählen? Nimm |cffc89530Benutzerdefiniert|r.",
    ...
    ["ins_recap_preset"]         = "Konfiguration angewendet: |cff0cd29f%s|r",
    ["ins_recap_custom"]         = "Deine benutzerdefinierte Konfiguration ist bereit",
    ["ins_recap_desc"]           = "Lade deine Oberfläche neu, um alles anzuwenden. Du kannst diesen Assistenten jederzeit mit |cff0cd29f/tm install|r erneut öffnen und das vollständige Konfigurationsfenster mit |cff0cd29f/tm|r.",
    ["cat_accueil"]              = "Start",
