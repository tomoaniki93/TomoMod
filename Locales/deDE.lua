...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_352_settings"] = "Hinweis — Was du vor dem Update wissen solltest: Die Optionsseite der Aktionsleisten ist in dieser Version nur eine Meldung, und die Leisten starten mit den Standardwerten des neuen Moduls statt mit den Werten, die du eingestellt hattest. Was du hattest, ist nicht verloren — es liegt unangetastet in deinem Profil —, aber jedes Bedienelement dieser Seite schrieb in ein System, das es nicht mehr gibt, und fünfundvierzig davon wirkungslos auf dem Bildschirm zu lassen wäre schlimmer gewesen, als es offen zu sagen. Die Seite kehrt im nächsten Update zurück, verdrahtet mit dem, was die Leisten jetzt tatsächlich lesen, und deine Einstellungen kehren mit ihr zurück.",
