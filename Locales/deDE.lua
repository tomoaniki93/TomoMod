...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns: Die Cooldowns-Seite trägt jetzt neben der Schaltfläche für das Cooldown Studio ein Häkchen „Cooldown-Manager-Leisten ausblenden“. Sobald Ihre Abklingzeiten auf Ihren eigenen Leisten liegen, hat TomoMods Umgestaltung von Blizzards vier Anzeigen nichts mehr zu tun — und der Schalter dafür lag in einer anderen Kategorie, also nicht dort, wo Sie stehen, wenn Sie zu diesem Schluss kommen. Es ist dieselbe Einstellung wie die unter CD & Ressourcen, nur andersherum formuliert. Beachten Sie: Sie beendet TomoMods Gestaltung dieser Anzeigen; die Anzeigen selbst schalten Sie in Blizzards Bearbeitungsmodus ab.",
