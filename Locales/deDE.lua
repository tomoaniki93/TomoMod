...
TomoMod_RegisterLocale("deDE", {
    ...
    ["wn_345_aura_engine"] = "Neu — Schwächungen und Stärkungen auf feindlichen Namensplaketten fehlten während des größten Teils eines Kampfes, und nichts wies darauf hin: kein Fehler, nichts auf der Plakette, nur eine Lücke dort, wo das Gesuchte hätte stehen sollen. Alles andere in dieser Version macht eine verweigerte Aura-Abfrage harmlos; nichts davon bringt die Aura zurück, denn das Spiel rückt sie nicht heraus, solange gekämpft wird. Also fragt TomoMod nicht mehr. Es beschreibt jetzt, was es will — diese Auren, so viele, so angeordnet, so gestaltet — und das Spiel sucht und sortiert selbst und reicht die fertigen Symbole zurück. Auf TomoMods Seite liest nichts mehr eine Aura, also bleibt nichts mehr zu verweigern. Der alte Weg wurde entfernt statt als Reserve behalten: Diese Version setzt den Patch, der den neuen bringt, ohnehin voraus, und eine Reserve, die niemand je benutzt, verrottet still. Zwei Fehler kamen dabei ans Licht. Beim Ausblenden einer Plakette wurde noch die Symbolliste angefasst, die es nicht mehr gibt — das hätte bei jedem gestorbenen Gegner und jeder Plakette außer Reichweite einen Fehler geworfen. Und ein Symbol, das mitten im Kampf entstand, kam ohne Größe heraus und zeichnete dauerhaft gar nichts: Das Spiel verweigert die Größe im Kampf ebenso wie die Aura, und das Symbol wurde nur ein einziges Mal eingerichtet. Symbole merken sich nun die erwartete Größe und übernehmen sie, sobald das Spiel es zulässt.",
