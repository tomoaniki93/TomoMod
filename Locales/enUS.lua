...
TomoMod_RegisterLocale("enUS", {
    ...
    ["wn_335_cdm_shortcut"] = "Cooldowns: the Cooldowns panel now carries a 'Hide the Cooldown Manager bars' tick next to the Cooldown Studio button. Once your cooldowns are on your own bars, TomoMod's restyling of Blizzard's four viewers has nothing left to do — and the switch for it lived in a different category, which is not where you are when you reach that conclusion. It is the same setting as the one in CD & Resources, worded the other way round. Note that it stops TomoMod dressing those viewers; switching the viewers themselves off is done in Blizzard's Edit Mode.",
