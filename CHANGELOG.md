...
- **New** - Skins > Chat Frame is now the live control centre for Chat V4. It can enable or disable the presentation, set background opacity from 0-100%, choose a 9-20px chat font, configure message behaviour, customise the complete sidebar and set the Copy Chat limit; every control applies immediately without a reload.
...
- **New** - All 22 Chat V4 option labels are translated for English, French, German, Spanish, Italian and Brazilian Portuguese.
...
- **New** - The redesigned sidebar provides custom vector-style icons, hover and pressed states, live Online/AFK/DND colouring, mute and deafen warnings, and online counts for Friends and Guild. It also exposes shortcuts for Social, Guild/Communities, chat channels and voice, chat copy, the Loot Browser, TomoMod settings and scroll-to-bottom.
